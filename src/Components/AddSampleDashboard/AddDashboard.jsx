    ...
    win.document.write(`
      ...
      <head>
        ...
        <style>
          ...
          img.qr { width: 200px; height: 200px; margin-bottom: 20px; border: 6px solid #00796b; border-radius: 16px; }
          a { color: #00695c; text-decoration: none; font-weight: bold; }
        </style>
      </head>
      <body>
        <h3>Scan this QR to view sample details:</h3>
        ...
        <p>Or open this link: <br><a href="${url}" target="_blank">${url}</a></p>
      </body>
      </html>
    `);
    win.document.close();
